...
<Meta title="TRAZiT Paradigm/Dev Libraries/Get data from context"/>

# GetDataFromContextFunctions

The `GetDataFromContextFunctions` JavaScript class is designed to let elements to get data from the different variables in context where data is stored.
