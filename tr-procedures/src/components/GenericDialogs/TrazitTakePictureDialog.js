...
//       this.defaultValue()
    ...
    mwc-textfield {
      ...
      mwc-select.outlined {        
        ...
        <tr-dialog id="takePictureDialog" @opened=${this.resetView}   ?open=${this.openTakePictureDialog(actionModel)} heading="" hideActions="" scrimClickAction="">
         ${this.lang==="en"?html`Turn on the cam, Take one picture of the plate and upload it`:html`Activa la cámara, toma una foto de la placa y súbela`}
         <camera-view id="cameraView"></camera-view>
        </tr-dialog>
    `
    }
    get cameraView() {return this.shadowRoot.querySelector("camera-view#cameraView")}
    get takePictureDialog() {return this.shadowRoot.querySelector("tr-dialog#takePictureDialog")}
