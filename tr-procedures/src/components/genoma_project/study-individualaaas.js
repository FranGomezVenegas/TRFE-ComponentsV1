...
export class StudyIndividuaaals extends CoreView {
  static get styles() {
  ...
  getLots() {
    ...
    this.fetchApi(params).then(j => {
      ...
      this.grid.items = this.selectedProgram.study_individual
...
customElements.define('study-individuaaals', StudyIndividuaaals);