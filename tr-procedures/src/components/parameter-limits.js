  ...
  render() {
    return html`
      ...
      <table class="styled-table">
        <thead>
          <tr>
            <th>${langConfig.configTableSpecLimits.variation["label_"+ this.lang]}</th>
            <th>${langConfig.configTableSpecLimits.analysis["label_"+ this.lang]}</th>
            <th>${langConfig.configTableSpecLimits.method_and_version["label_"+ this.lang]}</th>
            <th>${langConfig.configTableSpecLimits.parameter["label_"+ this.lang]}</th>
            <th>${langConfig.configTableSpecLimits.rule["label_"+ this.lang]}</th>
          </tr>
        </thead>
        <tbody>
