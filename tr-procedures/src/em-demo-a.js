    ...
    "actions": [
      {
        ...
        "apiParams": [
          ...
          { "query": "whereFieldsValue", "value": "Sampling|prog_pers_template|false*Boolean" }
        ],
        "paramFilter": {
          "SamplingSMP": { "query": "whereFieldsName", "value": "current_stage|sample_config_code not in*|requires_tracking_sampling_end" },
          "SamplingPERS": { "query": "whereFieldsName", "value": "current_stage|sample_config_code in*|requires_tracking_sampling_end" }
        }
      },
      {
    ...
    "actions": [
      {
        ...
        "apiParams": [
          { "query": "sampleFieldToRetrieve", "value": "sample_id|current_stage|status|status_previous|sampling_date|sampling_comment|sample_config_code|program_name|location_name|spec_code|spec_variation_name" },
          { "query": "whereFieldsValue", "value": "true*Boolean|Sampling|prog_pers_template" }
        ],
        "paramFilter": {
          "SamplingSMP": { "query": "whereFieldsName", "value": "requires_tracking_sampling_end|current_stage|sample_config_code not in*" },
          "SamplingPERS": { "query": "whereFieldsName", "value": "requires_tracking_sampling_end|current_stage|sample_config_code in*" }
        }
      },
      {
        "actionName": "GET_SAMPLE_AUDIT",
