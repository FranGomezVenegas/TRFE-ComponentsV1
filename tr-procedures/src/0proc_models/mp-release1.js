export const MpRelease1 = {
  ...
  "ModuleSettings":{
	  "actionsEndpoints":[
		{ "name": "Lots" , "url" : "/moduleinsplotrm/InspLotRMAPIactions"}
	  ],
	  "queriesEndpoints":[
		{ "name": "Lots" , "url" : "/moduleinsplotrm/InspLotRMAPIqueries"}
	  ]
  },
  "Home":{
  ...
  "LotView": {
	...
	"actions": [],
	  "tabs": [
		{"tabLabel_en": "Summary", "tabLabel_es": "Inicio", "view": "summary",
		 "view_definition":[
			...
			{"type": "readOnlyTable", "endPointResponseObject": "spec_definition", "endPointResponseObject2": "spec_limits",
			  "columns": [
				{"name":"variation_name", "label_en": "Variation", "label_es": "Variación"},
	  ...
	  "zzzztabs": [
		...
		{"tabLabel_en": "Samples", "tabLabel_es": "Muestras", "view": "lot-samples"},
		{"tabLabel_en": "CoA Preview", "Previa CdA": "Muestras", "view": "lot-coa"},
		...
		"columns": [
		 ...
		 {"type": "zzzjsonViewer","endPointResponseObject": "spec_definition"},
		 {"type": "zzzgrid", "title":{"label_en": "Info Matching Selection Criteria", "label_es": "Información cumpliendo el criterio de selección"}, 
           "elementName": "spec_limits", "endPointResponseObject": "spec_definition", "endPointResponseObject2": "spec_limits", 
		   "fieldsToDisplay":[
              {"property": "method_name", "header": "Method"}
           ]}
		 ]
		}
	  ]
