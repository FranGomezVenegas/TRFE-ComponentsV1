...
requirements="common-core tr-dialog platform-login cred-dialog relogin-dialog my-incidents my-certifications user-profile video-tutorial platform-notif tr-procedures endpoints-list"
